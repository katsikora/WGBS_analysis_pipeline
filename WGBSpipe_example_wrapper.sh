...
python /data/manke/repository/scripts/DNA_methylation/WGBS_pipe/v0.02/WGBS.pipe.ruffus.py --readIn /data/processing3/WGBS_pipe_test_IN/reads --ref GRCz10 --wdir /data/processing3/WGBS_pipe_example_OUT5 --trimReads  --fqcIn /data/processing3/WGBS_pipe_test_IN/in_fastqc --batchSize 24 --intList /data/processing3/WGBS_pipe_test_IN/danRer10.cpgIsland.ext.sorted.chr1.noCHR.bed --sampleInfo /data/processing3/WGBS_pipe_test_IN/example_sampleSheet.csv  
