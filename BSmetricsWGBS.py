...
def BS_QC_rep(Rpath,QCdir,logobject):
    cmd=os.path.join(Rpath,'Rscript -e "rmarkdown::render(\'"/data/manke/repository/scripts/DNA_methylation/WGBS_pipe/v0.02/WGBS_QC_report_template.Rmd"\',params=list(QCdir=\'"' + QCdir +'"\' ),output_file =\'"'+ os.path.join(QCdir,'QC_report.pdf"\'')+')"')
    logobject.info(cmd)
